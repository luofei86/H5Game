...
COLUMNS = " id, champion_name, champion_url, keyword, sign_word, url, title, content, resource_url, poster_url, prize_time "
...
#######def __init__(self, id, keyword, signWord, url, title, content, resourceUrl):
	def _toObject(self, db_item):
		if db_item is None:
			return None
		return GameActiveInfo(db_item[0], db_item[1], db_item[2], db_item[3], db_item[4], db_item[5], db_item[6], db_item[7], db_item[8], db_item[9], db_item[10])
